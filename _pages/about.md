...
- **B.Eng.**, Shanghai Jiao Tong University, 2020 – 2024 (graduated June 2024).
  - Previously advised by Prof. Junxian He.
- **Awards**
...
- **On the Perception Bottleneck of VLMs for Chart Understanding**  
  **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. *arXiv*, 2025. (First author.) Code: Vision4Chart (GitHub).

- **On the Universal Truthfulness Hyperplane Inside LLMs**  
  **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. *EMNLP 2024*. (First author.) Code: Universal_Truthfulness_Hyperplane (GitHub).
